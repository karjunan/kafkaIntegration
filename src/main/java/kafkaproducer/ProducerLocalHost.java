...
public class ProducerLocalHost {

    static final String TOPIC = "customer";

    //        static final String TOPIC = "words-input1";
//    static final String SERVERS="pkc-4ygw7.ap-southeasSt-2.aws.confluent.cloud:9092";
...
//
        ...
        int val = 0;
        String[] names = {"Krishna", "Ram", "Frank", "Mark", "Yarn"};
        String[] company = {"Google", "Microsoft", "Wallmart", "Facebook", "LinkedIn"};

        for (int i = 0; i < 5; i++) {
            JsonObject jsonObject = new JsonObject();
            jsonObject.addProperty("id", val++);
            jsonObject.addProperty("name", names[i]);
            jsonObject.addProperty("company", company[i]);
